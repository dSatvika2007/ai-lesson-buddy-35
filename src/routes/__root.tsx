  ...
  head: () => ({
    meta: [
      ...
      { title: "AI Teacher — Learn any topic concept by concept" },
      {
        name: "description",
        content:
          "Turn any topic or document into an AI-guided lesson with concept checks, a final quiz and a personal learning report.",
      },
      { property: "og:title", content: "AI Teacher" },
      {
        property: "og:description",
        content: "AI-guided lessons with concept checks, quizzes and a personal learning report.",
      },
